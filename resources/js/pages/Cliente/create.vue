...
const props = defineProps<{
    item?: { id: number; nome: string; cpf: string; contato: string };
...
const form = useForm({
    ...
    contato: props.item?.contato.toString() || ''
});
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border md:min-h-min">
                ...
                <div>
                    ...
                    <Input id="cpf" v-model="form.cpf" type="text" placeholder="Digite CPF" />
                </div>
                <div>
                    <Label for="contato">Contato</Label>
                    <Input id="contato" v-model="form.contato" type="text" placeholder="Digite Contato" />
                </div>
